...
REM AStylep must be run to create the *.gcno files
...
"C:\Program Files (x86)\SciTE\SciTE"  %USERPROFILE%\Projects\AStyleTest\build\cb-mingw\objp\AStyle\src\%gcovfile%.cpp.gcov
