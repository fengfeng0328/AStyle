...
echo -
choice /m "Do you want to restore the TEST repository?"
if errorlevel 2 exit

REM do NOT use backslashes in the file paths
REM do NOT use %USERPROFILE% becaue of the backslashes
set projdir=/cygdrive/C/Users/%USERNAME%/Projects/TestSvn/Repository
set mirror=/cygdrive/C/Users/%USERNAME%/Projects/TestSvn/Mirror

echo -
echo -
echo * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
echo *                  Restoring SVN Files                  * 
echo * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
rsync -av  %mirror%/*  %projdir%
