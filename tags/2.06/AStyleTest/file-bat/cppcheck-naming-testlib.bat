...
if not exist "srclib/AStyleTestLib_AStyleMain.cpp.dump" (
echo Creating dump files
"C:/Program Files/Cppcheck/cppcheck.exe"  --dump --force  srclib/ > srclib\dump.txt
del srclib\dump.txt
)
...
set count=0
for %%v in (srclib\*.cpp) do set /a count += 1
...
"C:/Program Files/Python 3.5/python.exe"  "%USERPROFILE%/Projects/AStyleTest/file-py/naming.py"  --var=%var% --function=%func% --class=%class%  "srclib/AStyleTestLib_AStyleMain.cpp.dump"
"C:/Program Files/Python 3.5/python.exe"  "%USERPROFILE%/Projects/AStyleTest/file-py/naming.py"  --var=%var% --function=%func% --class=%class%  "srclib/AStyleTestLib_Main.cpp.dump"
