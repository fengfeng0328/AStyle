@REM compare sciteOLD to scite and display files that are different
@echo off

set testdata=%USERPROFILE%\Projects\TestData

set indir=%testdata%\scite
set indirOLD=%testdata%\sciteOLD

REM optional statement to run Artistic Style
:: set progdir=..\AStyle\_VC-2008\bin
::%progdir%\AStyle.exe   -R  "%testdata%\scite\*.cxx"
